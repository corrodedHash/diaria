...
hidden if the `DIARIA_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `DIARIA_DEVELOPER_MODE` to the configure
...
Runs the executable target `diaria`.
